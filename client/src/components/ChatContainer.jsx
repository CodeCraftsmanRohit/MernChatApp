...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      {/* {chat messages} */}
      <div className="flex flex-col h-[calc(100%-102px)] overflow-y-scroll p-3 pb-6">
   ...
   <div className="flex items-center gap-3 p-3 border-t border-stone-500 bg-[#181A2A] rounded-full">
